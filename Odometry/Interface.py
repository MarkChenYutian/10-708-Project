...
from DataLoader import SequenceBase, DataFrame
...
class IVisualOdometry(ABC, Generic[T_Frame]):
    ...
    def receive_frames(self, sequence: SequenceBase[T_Frame], saveto: Sandbox, on_frame_finished: None | Callable[[T_Frame, Self, ColoredTqdm], None]=None):
        try:
            reference_poses = []
            ...
            global_map.save_poses(saveto.path("poses.npy"), "body")
