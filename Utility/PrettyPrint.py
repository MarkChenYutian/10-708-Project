import logging
import os
from typing import Any, Literal, Callable, TypeVar, ParamSpec, Optional, Iterable
...
class ColoredTqdm(tqdm):
    ...
    def __call__(self, arg: Iterable[O], *args, **kwds: Any) -> Iterable[O]:
...
def IgnoreException(func: Callable[I, O]) -> Callable[I, Optional[O]]:
    @wraps(func)
    def wrapped(*args: I.args, **kwargs: I.kwargs) -> Optional[O]:
        try:
