...
def visualize_run(seq: SequenceBase | None, space: Sandbox, start: int, to: int):
...
if __name__ == "__main__":
    ...
    if args.data is None:
        ...
        visualize_run(SequenceBase.instantiate(**datacfg_dict), Sandbox.load(args.space), args.from_frame, args.to_frame)
